...
class AddMoneyVC: UIViewController,STPApplePayContextDelegate, STPAddCardViewControllerDelegate{
    ...
    lazy var AddMoney:PKPaymentButton={
        ...
        if #available(iOS 14.0, *) {
            btn = PKPaymentButton(paymentButtonType: .addMoney, paymentButtonStyle: .black)
        } else {
